    ...
    getRentDetailsApi(id, from, to, function (data) {
        ...
        if (arr.length > 0) {
            $.each(arr, function (i, item) {
                ...
                html += '<td><a id="single_image" href="http://kgp.azurewebsites.net/Resources/Images/' + item.SaleReceiptImage + '" target="_blank"><img src="http://kgp.azurewebsites.net/Resources/Images/' + item.SaleReceiptImage + '" alt="" height="50" width="50"/></a></td></tr>';
            });
            html += '</tbody></table>';
